  ...
  render() {
    ...
    return (
      <div className="audio_attachment_wrapper">
         ...
         <audio controls>
          <source src={replace_url +i.url} type="audio/mpeg"/>
          <source src={replace_url +i.url} type="audio/ogg"/>
           ...
           <a href={replace_url +  i.url}>Download this lovely song and wish you all the best!</a>
        </audio>
      </div>
    );
  }
